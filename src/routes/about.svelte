...
<Section title="About" top={true} color="blue">
  <p>I&rsquo;m Darren Jansson (he/him), a senior frontend developer and engineer based in the UK. I&rsquo;ve been working both in-house and remotely for over {new Date().getFullYear() - 2004} years now, creating apps and websites for clients all over the world.</p>
  ...
  <div class="c-gallery">
    <div class="c-gallery__video">
      <div class="c-video">
        <iframe class="c-video__iframe" src="https://player.vimeo.com/video/645819602?h=8a411f6905" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" title="Video of glass work" allowfullscreen></iframe>
      </div>
    </div>
...
<style lang="scss">
  ...
  .c-gallery {
    ...
    @media (min-width: $breakpoint-gallery) {

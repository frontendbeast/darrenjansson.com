...
<Section color="black">
  <Work title="Auto Trader" color="#222b5e" logo="/images/logo-bg-autotrader.svg" logoWidth={156} logoHeight={20} logoSpacingX={20} logoSpacingY={40}>
  ...
  <Work title="Co-op Shifts" subtitle="Staff shift management progressive web app" color="#00B1E7" logo="/images/logo-bg-coop.svg" logoWidth={47} logoHeight={50} logoSpacingX={20} logoSpacingY={70}>
  ...
  <Work title="Channel Mum" subtitle="Parenting community progressive web app" color="#f55e62" logo="/images/logo-bg-channelmum.svg" logoWidth={124} logoHeight={34.84} logoSpacingX={20} logoSpacingY={60}>
  ...
  <Work title="Go Euro (now Omio)" subtitle="Parenting community progressive web app" color="#132968" logo="/images/logo-bg-goeuro.svg" logoWidth={133} logoHeight={24.7} logoSpacingX={20} logoSpacingY={60}>
    <p>Lead frontend developer for React application, front end process (incluinding test-driven development), architecture and development. Utilises Redux, Algolia and Contenful API.</p>
  </Work>
  ...
  <Work title="Go-Ahead Group" subtitle="Multiple train booking and information sites" color="#0e78be" logo="/images/logo-bg-goahead.svg" logoWidth={133} logoHeight={21.2} logoSpacingX={20} logoSpacingY={50}>
    <p>(London Midland, Southeastern, Southern, Great Northern, Thameslink, Gatwick Express)</p>
  ...
  <Work title="Amnesty International" subtitle="Global human rights site" color="#ff0" logo="/images/logo-bg-amnesty.svg" logoWidth={133} logoHeight={44.7} logoSpacingX={20} logoSpacingY={64.7}>
  ...
  <Work title="Bupa" subtitle="Private healthcare site" logo="/images/logo-bg-bupa.svg" color="#00aeef" logoWidth={47} logoHeight={47} logoSpacingX={20} logoSpacingY={77}>
    <p>Rapid prototyping and contributing to creation of component library for new site.</p>
  </Work>
  <Work title="HMV" subtitle="Music retailer site" color="#ed0677" logo="/images/logo-bg-hmv.svg" logoWidth={133} logoHeight={28.2} logoSpacingX={20} logoSpacingY={56.4}>
